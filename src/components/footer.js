...
function FooterRestau (){
    return(
        <>
        <footer class="footer-area ">
            <div class="footer-widget section-padding  py-5">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="single-widget single-widget1">
                                <a href="index.html" class="title-footer"><span class="prime-color">food</span>fun</a>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7 col-md-6">
                            <span>
                                Copyright © 2021 All rights reserved <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" class="color-copy">Fedia Hamdi</a>
                            </span>
                        </div>
